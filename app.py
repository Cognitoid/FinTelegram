...
# Загрузка переменной окружения, которую необходимо вынести за код, в константу.
load_dotenv()
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN')

# Константы вынесены за пределы основного кода, для того чтобы в случае изменения API Банка России их было легко скорректировать.
...
# Открывается файл для записи логов. Данный файл необходим для выявления и исправления ошибок в работе программы.
logging.basicConfig(
